...
def test_predict_before_fit_raises() -> None:
    with pytest.raises(RuntimeError, match="logistic_regression"):
        LogisticRegressionModel().predict(HELD_OUT_ORIGINAL)
...
def test_model_id() -> None:
    assert LogisticRegressionModel().model_id == "logistic_regression"
